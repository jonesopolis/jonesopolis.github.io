...
export default function Contact() {
  return (
    <>
      <SEO
        title="Contact | Learning AI"
        description="Get in touch to discuss AI, development, or collaboration opportunities."
      />
        ...
        <section className="page-section">
          ...
          <div className="contact-content">
            <p className="contact-intro">
              I'm always interested in discussing AI, machine learning, and software development.
