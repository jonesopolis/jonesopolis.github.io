...
export default function PostDetailClient({ post, settings, relatedPosts }) {
    ...
    <>
      ...
      <div className={`sticky-title-bar ${showStickyTitle ? 'sticky-title-bar--visible' : ''}`}>
        <div className="sticky-title-content">
          <Link href="/" className="sticky-back-btn" aria-label="Back to posts">
      ...
      <div className="container">
        <article className={`post-detail ${showStickyTitle ? 'post-detail--sticky-active' : ''}`}>
          ...
          <RelatedPosts posts={relatedPosts} settings={settings} />
        </article>
      </div>
    </>
  );
